...
>
> **TrendX adoption note**: This template is the selected target architecture. Example
> paths such as `packages/api/*` and imports such as `@your-app/*` describe the intended
> scaffold, not files that already exist in this repository today.
